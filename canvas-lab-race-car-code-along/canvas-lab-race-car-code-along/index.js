...
function updateCanvas() {
    ...
    for(let i = 0; i<currentGame.obstacles.length; i++) {
        ...
        if (detectCollision(currentGame.obstacles[i])) { // frenquencia que aparencem os obstacles, a matemática é somente para dizer quando forem multiplos de 100 aparecer um obstaculo
            alert('BOOOOOMM!')
